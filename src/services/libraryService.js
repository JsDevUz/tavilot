...
export const librarySections = [
  {
    key: "moturudiy",
    titleKey: "abuMansurMotrudiy",
    path: "/api/v1/moturudiy/",
  },
  {
    key: "manuscript",
    titleKey: "manuscriptAndComments",
    path: "/api/v1/manuscript/",
  },
  { key: "studies", titleKey: "modernStudies", path: "/api/v1/studies/" },
  {
    key: "resources",
    titleKey: "resources",
    path: "/api/v1/resources/category/",
  },
  {
    key: "refusal",
    titleKey: "rebuttalsToFanaticism",
    path: "/api/v1/refusal/",
  },
];
